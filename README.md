# Emission Scenario Reweighting Framework
...
<img src="figures/framework_overview.png" alt="Figure overview">
...
## How to run?
At present, to run the weighting procedure, users can launch the [run.py](src/scenario_reweighting/run.py) module. Some parameters need updating within the [run.py](src/scenario_reweighting/run.py) file before getting started. Detailed guidance on how to use the run module can be found in the [run README](src/scenario_reweighting/RUN_README.md).

For detailed guidance on how to configure each of the modules, refer to the relevant [diversity](src/scenario_reweighting/DIVERSITY_README.md), [quality](src/scenario_reweighting/QUALITY_README.md) and [relevance](src/scenario_reweighting/RELEVANCE_README.md) weighting README files. 
